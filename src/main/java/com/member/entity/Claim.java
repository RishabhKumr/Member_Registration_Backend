...
public class Claim {
	...
	public Claim(String claimId, String claimName, String claimType, String claimAmount, String claimFor,
			String claimerId, String claimAdmissionDate, String claimDischargeDate, String claimProvider,
			String claimerName, String claimerDOB) {
		super();
